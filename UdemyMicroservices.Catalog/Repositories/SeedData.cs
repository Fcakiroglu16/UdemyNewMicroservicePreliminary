    ...
    public static class SeedData
    {
        ...
        private static async Task SeedDatabaseAsync(AppDbContext context)
        {
            if (!context.Categories.Any())
            {
                ...
                {
                    new Category { Id = NewId.NextGuid(), Name = "Development" },
                    new Category { Id = NewId.NextGuid(), Name = "Business" },
                    new Category { Id = NewId.NextGuid(), Name = "IT & Software" },
                    new Category { Id = NewId.NextGuid(), Name = "Office Productivity" },
                    new Category { Id = NewId.NextGuid(), Name = "Personal Development" },
                };
